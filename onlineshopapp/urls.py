...
from onlineshopapp.shop_views import (CategoryViewSet,ProductViewSet,get_product_by_category_id,
                                      ...
                                      ActiveFlashSaleViewSet,RegisterAPIView,my_orders)
...
router.register(r'wishes',WishlistViewSet,basename='wishes')
router.register(r'flash-sale',ActiveFlashSaleViewSet,basename='flash-sale')
